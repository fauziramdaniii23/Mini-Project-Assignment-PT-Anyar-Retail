<!-- Modal -->
<div class="modal fade" id="modalShowPresensi{{ $presen->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Detail Presensi Karyawan</h5>
        ...
        <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="date" value="{{ $presen->tanggal }}" id="tanggal" name="tanggal" class="form-control" required>
                </div>
